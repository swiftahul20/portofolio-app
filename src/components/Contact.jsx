...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-screen bg-[#a3c7ed] flex justify-center items-center p-4 dark:bg-[#121212]"
    >
      <form
        method="POST"
      ...
      >
        <div className="pb-3">
          ...
          <p className="text-[#202b4b] py-4 dark:text-gray-400"> You can contact me via this form </p>
        </div>
        <input
